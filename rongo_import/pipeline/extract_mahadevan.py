...
RAW = os.path.join(ROOT, "data", "raw", "mahadevan")
OUT = os.path.join(ROOT, "data", "glyphs", "indus")
...
def main():
    ...
    json.dump(manifest, open(os.path.join(ROOT, "data", "glyphs", "indus_manifest.json"), "w"), indent=1)
