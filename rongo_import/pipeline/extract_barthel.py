...
RAW = os.path.join(ROOT, "data", "raw", "barthel")
OUT = os.path.join(ROOT, "data", "glyphs", "rongorongo")
...
def main():
    ...
    json.dump(manifest, open(os.path.join(ROOT, "data", "glyphs", "rongorongo_manifest.json"), "w"), indent=1)
