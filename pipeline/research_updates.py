...
def signal_page(r):
    ...
    return shell('Where is the signal?','A descriptive audit of the 62.5% teaching-figure result, broken into its repeated pairings.',body,extra='<link rel="stylesheet" href="research.css">')
...
def bath_page(r):
    ...
    return shell('What a coarse grid erases','A reproducible resolution experiment on the published Baltic AUV survey.',body,extra='<link rel="stylesheet" href="research.css">')
