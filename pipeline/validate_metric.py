...
QDIR = os.path.join(ROOT, "data", "raw", "barthel", "kohaumotu_thumbs")
...
def main():
    ...
    for fn in sorted(os.listdir(QDIR)):
        ...
        tmp = os.path.join(ROOT, "data", "qa", "_q.png"); im.save(tmp)
    ...
    json.dump(res, open(os.path.join(ROOT, "data", "results", "validation.json"), "w"), indent=1)
